...
var ArrayPlugin = /*#__PURE__*/(0, _createClass2.default)(function ArrayPlugin(_value, _key) {
  var _this = this;
  ...
  if (typeof _value === 'string') {
    if (_key.match(_utils.shadowExp)) {
      this.value = (0, _styleUtils.parseShadow)(_value, _key);
      _type = 'shadow';
    } else if (_key.match(/color|fill|stroke/i) || _value.match(_utils.colorRegExp)) {
      this.value = (0, _styleUtils.parseColor)(_value);
      _type = 'color';
    } else {
